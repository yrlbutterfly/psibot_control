...
class Frame_t(ctypes.Structure):
    _fields_ = [("head", ctypes.c_uint8), ("id", ctypes.c_uint16),
                ("len", ctypes.c_uint8),
...
check = 0
tcmd = Frame_t()
pdata = (ctypes.c_uint8 * ctypes.sizeof(Frame_t)).from_address(
    ctypes.addressof(tcmd))

if USE_RS485:
    bus = serial.Serial("COM6", 5000000, timeout=1)
else:
    if USE_CANFD:
        bus = can.interface.Bus(channel=CAN_ID,
                                interface='socketcan',
                                fd=True,
                                bitrate=1000000,
...
class ServoData(ctypes.Union):
    _fields_ = [("stuCmd", FingerServoCmd), ("stuInfo", FingerServoInfo),
                ("pucDat", ctypes.c_uint8 * 64)]


class MsgHook(ctypes.Structure):
    _fields_ = [("ucEn", ctypes.c_uint8), ("ucAlive", ctypes.c_uint8),
                ("pstuMsg", ctypes.POINTER(CanMsg)), ("funCbk", Callback_t)]


class MsgListen(ctypes.Structure):
    _fields_ = [("stuListen", MsgHook), ("stuRet", ServoData),
                ("ucConfidence", ctypes.c_uint8)]


class RyCanServoBus(ctypes.Structure):
    _fields_ = [("pusTicksMs", ctypes.POINTER(ctypes.c_uint16)),
...
class Servos_t(ctypes.Structure):
    _fields_ = [("raw", FingerServoInfo), ("p", ctypes.c_int16),
                ("v", ctypes.c_int16), ("t", ctypes.c_int16),
                ("f", ctypes.c_int16)]


lib.AddHook.argtypes = [
    ctypes.POINTER(RyCanServoBus),
    ctypes.POINTER(CanMsg),
    ctypes.CFUNCTYPE(ctypes.c_int)
]
lib.AddHook.restype = ctypes.c_int

lib.DeleteHook.argtypes = [
    ctypes.POINTER(RyCanServoBus),
    ctypes.POINTER(CanMsg)
]
lib.DeleteHook.restype = ctypes.c_int

lib.AddListen.argtypes = [
    ctypes.POINTER(RyCanServoBus),
    ctypes.POINTER(CanMsg), Callback_t
]
lib.AddListen.restype = ctypes.c_int

lib.DeleteListen.argtypes = [
    ctypes.POINTER(RyCanServoBus),
    ctypes.POINTER(CanMsg)
]
lib.DeleteListen.restype = ctypes.c_int

lib.GetServoUpdateInfo.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(MsgListen)
]
...
lib.RyCanServoBusInit.argtypes = [
    ctypes.POINTER(RyCanServoBus), BusWrite_t,
...
lib.RyFunc_GetServoInfo.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ServoData), ctypes.c_uint16
]
lib.RyFunc_GetServoInfo.restype = ctypes.c_uint8

lib.RyFunc_GetVersion.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint8 * 64,
    ctypes.c_uint16
]
lib.RyFunc_GetVersion.restype = ctypes.c_uint8

lib.RyFunc_StartUpgrade.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint32,
...
lib.RyFunc_WriteUpgradeData.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint32,
...
lib.RyFunc_FinishUpgrade.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint16,
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint16
]
lib.RyFunc_FinishUpgrade.restype = ctypes.c_uint8

lib.RyFunc_SetSNCode.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint8 * 40,
    ctypes.c_uint16
]
lib.RyFunc_SetSNCode.restype = ctypes.c_uint8

lib.RyFunc_GetSNCode.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint8 * 40,
    ctypes.c_uint16
]
lib.RyFunc_GetSNCode.restype = ctypes.c_uint8

lib.RyParam_SetTime.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, DevTimeCmd, ctypes.c_uint16
]
lib.RyParam_SetTime.restype = ctypes.c_uint8

lib.RyParam_SetID.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint16
]
lib.RyParam_SetID.restype = ctypes.c_uint8

lib.RyParam_Recover.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint16
]
lib.RyParam_Recover.restype = ctypes.c_uint8

lib.RyParam_GetRigidity.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint8), ctypes.c_uint16
]
lib.RyParam_GetRigidity.restype = ctypes.c_uint8

lib.RyParam_SetRigidity.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint8,
    ctypes.c_uint16
]
lib.RyParam_SetRigidity.restype = ctypes.c_uint8

lib.RyParam_SetPosition.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint16,
    ctypes.POINTER(ctypes.c_uint16), ctypes.c_uint16
]
lib.RyParam_SetPosition.restype = ctypes.c_uint8

lib.RyParam_ClearFault.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint16
]
lib.RyParam_ClearFault.restype = ctypes.c_uint8

lib.RyParam_GetProtectionCfg.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint16), ctypes.c_uint16
]
lib.RyParam_GetProtectionCfg.restype = ctypes.c_uint8

lib.RyParam_SetProtectionCfg.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint16), ctypes.c_uint16
]
lib.RyParam_SetProtectionCfg.restype = ctypes.c_uint8

lib.RyParam_GetStroke.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint16
]
lib.RyParam_GetStroke.restype = ctypes.c_uint8

lib.RyParam_SetStroke.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint32,
    ctypes.c_uint16
]
lib.RyParam_SetStroke.restype = ctypes.c_uint8

lib.RyParam_GetStroke_H.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint16
]
lib.RyParam_GetStroke_H.restype = ctypes.c_uint8

lib.RyParam_SetStroke_H.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint32,
    ctypes.c_uint16
]
lib.RyParam_SetStroke_H.restype = ctypes.c_uint8

lib.RyParam_GetStroke_L.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8,
    ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint16
]
lib.RyParam_GetStroke_L.restype = ctypes.c_uint8

lib.RyParam_SetStroke_L.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_uint32,
    ctypes.c_uint16
]
lib.RyParam_SetStroke_L.restype = ctypes.c_uint8

lib.RyMotion_ServoMove_Speed.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_int16,
    ctypes.c_uint16,
    ctypes.POINTER(ServoData), ctypes.c_uint16
]
lib.RyMotion_ServoMove_Speed.restype = ctypes.c_uint8

lib.RyMotion_ServoMove_Pwm.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_int16,
    ctypes.POINTER(ServoData), ctypes.c_uint16
]
lib.RyMotion_ServoMove_Pwm.restype = ctypes.c_uint8

lib.RyMotion_CurrentMode.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_int16,
    ctypes.POINTER(ServoData), ctypes.c_uint16
]
lib.RyMotion_CurrentMode.restype = ctypes.c_uint8

lib.RyMotion_ServoMove_Mix.argtypes = [
    ctypes.POINTER(RyCanServoBus), ctypes.c_uint8, ctypes.c_int16,
...
def bus_write_callback(can_msg):
    ...
    # 获取 can_msg 的地址
    # print(f"can_msg address: {ctypes.addressof(can_msg):#x}")
    ...
    if systype == 'Linux' and cpuarch == 'x86_64':
        ...
        adjusted_address = ctypes.addressof(can_msg.contents) + 0x610
        # print(f"Adjusted can_msg contents address: {adjusted_address:#x}")

        # # Convert the adjusted address back to a CanMsg object
        adjusted_can_msg = ctypes.cast(adjusted_address,
                                       ctypes.POINTER(CanMsg)).contents
        ...
        for byte in data:
            ...
            if rcvsta == CMD_HEADER:
                ...
                if tcmd.check == pdata[RxIndex - 1]:
                    ...
                    lib.RyCanServoLibRcvMsg(ctypes.byref(servo_bus),
                                            received_msg)
                ...
                ctypes.memset(ctypes.addressof(tcmd), 0,
                              ctypes.sizeof(Frame_t))
                RxIndex = 0
                rcvsta = CMD_HEADER
...
def listened_callback(can_msg, para):
    ...
    if id and (id < 7):
        servos_info[id - 1].raw = ctypes.cast(
            can_msg.contents.pucDat, ctypes.POINTER(FingerServoInfo)).contents
...
def update_motor_positions(angles):
    ...
    for i in range(6):
        ...
        # lib.RyMotion_ServoMove_Speed(ctypes.byref(servo_bus), i + 1, cmds[i],
        #                              3000, ctypes.byref(servo_data), 0)
        ret = lib.RyMotion_ServoMove_Mix(ctypes.byref(servo_bus), i + 1,
                                         cmds[i], 3000, 1000,
                                         ctypes.byref(servo_data), 0)
        if ret != OK:
...
if __name__ == '__main__':
    ...
    response_code = lib.RyCanServoBusInit(ctypes.byref(servo_bus), c_bus_write,
                                          ctypes.byref(ticks_var), 1000)
    ...
    if response_code == 0:
        ...
        for i in range(15):
            ...
            ret = lib.AddListen(ctypes.byref(servo_bus),
                                ctypes.byref(stuListenMsg[i]), c_callback1)

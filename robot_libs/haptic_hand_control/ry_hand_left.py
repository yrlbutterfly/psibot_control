...
API_VERISON = 1.0
if API_VERISON == 1.0:
    from RyHandLibSocketCan_6_left import *
elif API_VERISON == 2.0:
    from RyHandLibSocketCan_6x_left import *
else:
...
if __name__ == "__main__":
    ...
    left_hand.init()
    # leftleft_hand = RyLeftHand()

    # N = 100
    # for n in range(N):
    #     _angle = n/(N-1)
    #     angles = [_angle,0.0,0,0,1.0,1.0]
    #     left_hand.set_angles(angles)        
    #     angles = left_hand.get_angles()
    ...
    # angles = [0.5, 0.3, 0.0, 0.5, 0.0, 0.0]
    # left_hand.set_angles(angles)
    # time.sleep(2)
    # angles = left_hand.get_angles()
    # print(f"angles: {angles}")
    ...
    for n in range(20):
        ...
        left_hand.set_angles(angles.copy())
        time.sleep(1)
